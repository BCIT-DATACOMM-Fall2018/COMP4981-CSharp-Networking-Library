...
{
	/// ----------------------------------------------
	/// Class: NameElement - A MessageElement to store a clients ID in a packet
	/// 
	/// PROGRAM: NetworkLibrary
	///
	/// CONSTRUCTORS:	public NameElement (int clientID)
	...
	public class NameElement : MessageElement
	{
		...
		/// PROGRAMMER:	Cameron Roberts
		/// 
		/// INTERFACE: 	public NameElement (int clientID)
		/// 
		/// NOTES:		
		/// ----------------------------------------------
